<script>
  ...
  function handleTokenExchangeFormBtn(event) {
      tokenExchangeFormState = true
...
<main class="w-full min-h-screen bg-gray-800 flex flex-col justify-center items-center text-center snap-y snap-mandatory overflow-hidden">
  ...
  {:else if tokenExchangeFormState}
    <div class="absolute z-50 top-0 left-0 w-full h-screen overflow-hidden" in:fade out:fade >
      <div class="hero min-h-screen bg-base-200">
        <div class="hero-content text-center">
          <div class="max-w-3xl">
            ...
            {#if metamaskState == true }
              <CreateExchangeForm handleExitBtn={handleExitBtn} />
            {/if}
          </div>
        </div>
      </div>
  ...
  {:else}
    <div class="flex items-center justify-center flex-col h-screen">
      ...
      <div class="w-8/12 flex justify-around w-full">
        ...
        <button class="btn btn-lg btn-info text-white capitalize font-normal text-xl" on:click={handleTokenExchangeFormBtn}>Token Exchange</button>
